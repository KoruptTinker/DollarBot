...
class LinkCodesModel:
    ...
    def create_link_code_telegram(
        self, link_collection: Collection, chat_id: int, link_code: str
    ):
        return link_collection.insert_one(
            {"chat_id": chat_id, "link_code": link_code, "discord_id": 0}
        )

    def create_link_code_discord(
        self, link_collection: Collection, discord_id: int, link_code: str
    ):
        return link_collection.insert_one(
            {"chat_id": 0, "link_code": link_code, "discord_id": discord_id}
        )
